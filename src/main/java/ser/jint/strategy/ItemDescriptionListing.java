...
public class ItemDescriptionListing extends ListingStrategyAdapter {
	...
	private class ItemDescriptionComparator implements Comparator<Items> {
		...
		public int compare(Items o1, Items o2) {
			return (ItemDescriptionListing.this.listingMode == ListingStrategy.ASC)
					? textComparator.compare(o1.getItemDescription(),
							o2.getItemDescription())
					: textComparator.compare(o2.getItemDescription(),
							o1.getItemDescription());
		}
	}
}
